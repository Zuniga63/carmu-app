    ...
    >
      <div className="flex gap-x-3">
        ...
        <div className="flex-grow">
          ...
          <div className="mt-2 flex justify-start gap-x-2 px-2">
            <Tooltip
              label={`Tiene ${productCount} producto${
                productCount !== 1 ? 's' : ''
              }`}
              color="blue"
              withArrow
            >
              <div className="flex cursor-help items-center text-xs">
                <IconBox size={16} className="mr-2 inline-block" />{' '}
            ...
            >
              <div className="flex cursor-help items-center text-xs">
                <IconCategory2 size={16} className="mr-2 inline-block" />{' '}
      ...
      <div className="mt-2 ml-10 flex gap-x-2">
        <Button
          ...
          onClick={() => dispatch(showCategoryForm(category))}
        >
